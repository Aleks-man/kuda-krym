import type { PlaceImage } from "../media/place-image.contract.js";

// Shared by the website and the image download/validation scripts.
export const cityCoverImages = {
  "simferopol": {
...
} as const satisfies Readonly<Record<string, PlaceImage & { sourceVerifiedAt: string }>>;
